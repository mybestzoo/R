...
strategies <- read.zoo("/Users/tigranbagramyan/Documents/R/strategyperfomance.csv", sep = ",", header = TRUE, format="%Y-%m-%d")
head(strategies)
...
#Note: The above histogram plots are taken from the example documentation
